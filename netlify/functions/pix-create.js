...
exports.handler = async (event) => {
  ...
  if (!clientId || !clientSecret) {
    console.error("[pix-create] Variaveis MISTICPAY_CLIENT_ID / MISTICPAY_CLIENT_SECRET nao configuradas");
  ...
  const payload = {
    ...
    payerDocument,
    transactionId,
    description: productName || "Kit Album Copa Do Mundo 2026 Capa Mole + 250 Figurinhas Panini",
    ...(webhookUrl ? { projectWebhook: webhookUrl } : {}),
  };

  console.log("[pix-create] Criando transacao:", { transactionId, amount: payload.amount, payerName: payload.payerName });
